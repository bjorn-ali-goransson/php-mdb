...
class MdbBackendType{
  var $name = "";
  var $needs_length = false;
  var $needs_scale = false;
  var $needs_quotes = false;
}

class MdbBackend{
  var $capabilities = 0; /* see MDB_SHEXP_* */
  var $types_table;
  var $type_shortdate;
  var $type_autonum;
  var $short_now = "";
  var $long_now = "";
  var $charset_statement = "";
  var $drop_statement = "";
  var $constaint_not_empty_statement = "";
  var $column_comment_statement = "";
  var $table_comment_statement = "";
  var $quote_schema_name = "";

  function __construct(){
    $this->types_table = new MdbBackendType;
    $this->type_shortdate = new MdbBackendType;
    $this->type_autonum = new MdbBackendType;
  }
}
...
class MdbFile{
  ...
  function __construct(){
    $this->default_backend = new MdbBackend;
    $this->stats = new MdbStatistics;
  }
}

/* offset to row count on data pages...version dependant */
class MdbFormatConstants{
  var $pg_size = 0;
  var $row_count_offset = 0; 
  var $tab_num_rows_offset = 0;
  var $tab_num_cols_offset = 0;
  var $tab_num_idxs_offset = 0;
  var $tab_num_ridxs_offset = 0;
  var $tab_usage_map_offset = 0;
  var $tab_first_dpg_offset = 0;
  var $tab_cols_start_offset = 0;
  var $tab_ridx_entry_size = 0;
  var $col_flags_offset = 0;
  var $col_size_offset = 0;
  var $col_num_offset = 0;
  var $tab_col_entry_size = 0;
  var $tab_free_map_offset = 0;
  var $tab_col_offset_var = 0;
  var $tab_col_offset_fixed = 0;
...
// #endif
  ...
  function __construct(){
    $this->f = new MdbFile;
    $this->default_backend = new MdbBackend;
    $this->fmt = new MdbFormatConstants;
    $this->stats = new MdbStatistics;
  }
}
