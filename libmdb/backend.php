...
// {
	...
	// 	quote_schema_name_rquotes_merge);
// }
function mdb_register_backend($backend_name, $capabilities, $backend_type, $type_shortdate, $type_autonum, $short_now, $long_now, $charset_statement, $drop_statement, $constaint_not_empty_statement, $column_comment_statement, $table_comment_statement, $quote_schema_name)
{
	...
	$mdb_backends[$backend_name] = $backend;
}
 ...
 */
function mdb_set_default_backend($mdb, $backend_name)
{
	$backend = $mdb_backends[$backend_name];
	if ($backend) {
